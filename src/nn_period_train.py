...
def train_network(dataset_dir):
    ...
    train_dataset = ConnlogsDataset(dataset_dir, nn_type='nn_period', tvt_type="train")
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=cfg["batch_size"],
                                       num_workers=cfg["num_workers"], shuffle=True)

    # Create test data loader
    test_dataset = ConnlogsDataset(dataset_dir, nn_type='nn_period', tvt_type="validate")
...
def run_test(nn, dataset_dir):
    # Create train data loader
    test_dataset = ConnlogsDataset(dataset_dir, nn_type='nn_period', tvt_type="test", timestamp=True)
    test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=cfg["batch_size"],
                                       num_workers=cfg["num_workers"], shuffle=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--modelPath', default="../out/models/nn_period_model.pt",
    ...
    with open(os.path.join(result_path, "nn_period.csv"), 'w') as f_csv:
